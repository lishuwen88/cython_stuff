...
#define __PYX_HAVE__pointers
#define __PYX_HAVE_API__pointers
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'pointers' */
static double __pyx_v_8pointers_golden_ratio;
static double *__pyx_v_8pointers_p_double;
#define __Pyx_MODULE_NAME "pointers"
extern int __pyx_module_is_main_pointers;
int __pyx_module_is_main_pointers = 0;
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pointers) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "pointers")) {
      if (unlikely(PyDict_SetItemString(modules, "pointers", __pyx_m) < 0)) __PYX_ERR(0, 3, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  __pyx_v_8pointers_p_double = (&__pyx_v_8pointers_golden_ratio);
 ...
 * 
 */
  (__pyx_v_8pointers_p_double[0]) = 1.618;
 ...
 */
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_8pointers_golden_ratio); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
 ...
 * print(p_double[0])             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = PyFloat_FromDouble((__pyx_v_8pointers_p_double[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pointers", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pointers");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT

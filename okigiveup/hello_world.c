 ...
 *     print("Hello world from Cython!")
 */
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_hello_world_pyx, __pyx_n_s_say_hello, 2, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *     print("Hello world from Cython!")
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_11hello_world_1say_hello, NULL, __pyx_n_s_hello_world); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
